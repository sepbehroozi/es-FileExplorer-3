...
.method public static a(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;)Lcom/estrongs/android/ui/dialog/ct;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;Ljava/lang/String;)Lcom/estrongs/android/ui/dialog/ct;
...
.method public static a(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;Ljava/lang/String;)Lcom/estrongs/android/ui/dialog/ct;
    .locals 10
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/estrongs/android/pop/utils/az;-><init>(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;[Ljava/lang/Boolean;)V

    new-instance v2, Lcom/estrongs/android/pop/utils/ba;

    invoke-direct {v2, p0, p1, v1}, Lcom/estrongs/android/pop/utils/ba;-><init>(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;[Ljava/lang/Boolean;)V

    new-instance v3, Lcom/estrongs/android/pop/utils/bb;

    invoke-direct {v3, p0, p1, v1}, Lcom/estrongs/android/pop/utils/bb;-><init>(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;[Ljava/lang/Boolean;)V
    ...
    new-instance v4, Lcom/estrongs/android/ui/dialog/ct;

    invoke-direct {v4, p0}, Lcom/estrongs/android/ui/dialog/ct;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, p2}, Lcom/estrongs/android/ui/dialog/ct;->a(Ljava/lang/CharSequence;)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v4

    invoke-virtual {v4, v9}, Lcom/estrongs/android/ui/dialog/ct;->b(I)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v4

    invoke-virtual {v4, v5, v2}, Lcom/estrongs/android/ui/dialog/ct;->d(ILandroid/content/DialogInterface$OnClickListener;)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v2

    const v4, 0x7f0b04ca

    invoke-virtual {v2, v4, v3}, Lcom/estrongs/android/ui/dialog/ct;->e(ILandroid/content/DialogInterface$OnClickListener;)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v2

    invoke-virtual {v2, v8, v0}, Lcom/estrongs/android/ui/dialog/ct;->f(ILandroid/content/DialogInterface$OnClickListener;)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v0

    :goto_0
    new-instance v2, Lcom/estrongs/android/pop/utils/bc;

    invoke-direct {v2, v1, p0}, Lcom/estrongs/android/pop/utils/bc;-><init>([Ljava/lang/Boolean;Landroid/app/Activity;)V

    invoke-virtual {v0, v2}, Lcom/estrongs/android/ui/dialog/ct;->a(Landroid/content/DialogInterface$OnDismissListener;)Lcom/estrongs/android/ui/dialog/ct;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/estrongs/android/util/a;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p2}, Lcom/estrongs/android/ui/dialog/ct;->a(Ljava/lang/CharSequence;)Lcom/estrongs/android/ui/dialog/ct;
    ...
    invoke-virtual {v3, v5, v2}, Lcom/estrongs/android/ui/dialog/ct;->c(ILandroid/content/DialogInterface$OnClickListener;)Lcom/estrongs/android/ui/dialog/ct;

    move-result-object v2

    invoke-virtual {v2, v8, v0}, Lcom/estrongs/android/ui/dialog/ct;->b(ILandroid/content/DialogInterface$OnClickListener;)Lcom/estrongs/android/ui/dialog/ct;
...
.method public static a(Landroid/app/Activity;Lcom/estrongs/fs/h;)V
    ...
    invoke-direct {v1, p0, v2, v3}, Lcom/estrongs/android/ui/dialog/eo;-><init>(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Lcom/estrongs/android/pop/utils/ak;

    invoke-direct {v2, p1, p0, v0}, Lcom/estrongs/android/pop/utils/ak;-><init>(Lcom/estrongs/fs/h;Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/estrongs/android/ui/dialog/eo;->b(Z)V

    invoke-virtual {v1, v4}, Lcom/estrongs/android/ui/dialog/eo;->a(Z)V
...
.method public static a(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Landroid/app/Activity;Ljava/lang/String;Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    invoke-static {p1}, Lcom/estrongs/android/util/an;->bM(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    new-instance v1, Lcom/estrongs/android/ui/dialog/by;

    invoke-direct {v1, p0, v0, p2}, Lcom/estrongs/android/ui/dialog/by;-><init>(Landroid/app/Activity;Ljava/lang/String;Landroid/content/DialogInterface$OnDismissListener;)V

    invoke-virtual {v1}, Lcom/estrongs/android/ui/dialog/by;->a()V
    :try_end_0
...
.method public static a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->bb(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_2

    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->t(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static/range {p1 .. p1}, Lcom/estrongs/fs/impl/j/b;->o(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->aB(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2}, Lcom/estrongs/android/ui/pcs/s;->b()Z
    ...
    invoke-direct {v2, v0, v1}, Lcom/estrongs/android/pop/utils/at;-><init>(Landroid/app/Activity;Ljava/lang/String;)V

    const-string v3, "\u4e34\u65f6\u7528\u6237"

    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->y(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v3, Lcom/estrongs/android/ui/pcs/a;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Lcom/estrongs/android/ui/pcs/a;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v2}, Lcom/estrongs/android/ui/pcs/a;->a(Lcom/estrongs/android/ui/pcs/o;)V

    invoke-virtual {v3}, Lcom/estrongs/android/ui/pcs/a;->a()V
    ...
    invoke-direct {v3, v0}, Lcom/estrongs/android/ui/pcs/j;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v2}, Lcom/estrongs/android/ui/pcs/j;->a(Lcom/estrongs/android/ui/pcs/o;)V
    ...
    :cond_4
    invoke-static/range {p0 .. p1}, Lcom/estrongs/android/pop/utils/aj;->b(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    :cond_7
    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->aG(Ljava/lang/String;)Z
    ...
    :cond_8
    invoke-static/range {p2 .. p2}, Lcom/estrongs/android/util/be;->b(Ljava/lang/CharSequence;)Z
    ...
    invoke-static {v2, v0}, Lcom/estrongs/android/util/an;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/estrongs/android/util/an;->bL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v5, v0, v2, v3}, Lcom/estrongs/android/pop/utils/au;-><init>(Landroid/app/Activity;Lcom/estrongs/fs/h;Lcom/estrongs/fs/h;)V
    ...
    invoke-direct {v2, v0, v3, v4, v5}, Lcom/estrongs/android/pop/utils/av;-><init>(Landroid/app/Activity;Ljava/lang/String;Lcom/estrongs/a/a;Z)V
    ...
    invoke-virtual {v2, v3, v5}, Lcom/estrongs/android/pop/utils/av;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/estrongs/android/ui/dialog/ix;

    move-result-object v2

    invoke-virtual {v2}, Lcom/estrongs/android/ui/dialog/ix;->show()V
    ...
    :cond_a
    invoke-static/range {p1 .. p1}, Lcom/estrongs/android/util/an;->bE(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v14}, Lcom/estrongs/android/pop/utils/aj;->a(Ljava/lang/String;)Z

    move-result v3

    if-nez v3, :cond_2a

    invoke-static {v12}, Lcom/estrongs/android/util/bd;->b(Ljava/lang/String;)I

    move-result v2

    invoke-static {v2}, Lcom/estrongs/android/util/bd;->E(I)Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_29

    invoke-static {v12}, Lcom/estrongs/android/util/bd;->S(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v12}, Lcom/estrongs/android/pop/utils/aj;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/app/Activity;Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lcom/estrongs/android/ui/pcs/s;->b()Z
    ...
    invoke-virtual {v0}, Lcom/estrongs/android/ui/pcs/s;->c()Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Lcom/estrongs/android/ui/pcs/s;->e()Ljava/lang/String;
    ...
    new-instance v2, Lcom/estrongs/android/pop/utils/an;

    invoke-direct {v2}, Lcom/estrongs/android/pop/utils/an;-><init>()V

    const/16 v3, 0x10

    invoke-direct {v1, p0, v0, v2, v3}, Lcom/estrongs/android/widget/g;-><init>(Landroid/app/Activity;Ljava/lang/String;Lcom/estrongs/fs/i;I)V
    ...
    new-instance v2, Lcom/estrongs/android/pop/utils/ao;

    invoke-direct {v2, p0, p1, v1}, Lcom/estrongs/android/pop/utils/ao;-><init>(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/android/widget/g;)V
    ...
    invoke-virtual {v1}, Lcom/estrongs/android/widget/g;->j()V
...
.method public static a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-static {p0, p1, p2, p3, v0}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;ZZ)V
...
.method public static a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;ZZLcom/estrongs/a/a/p;)V
    ...
    invoke-static {v3}, Lcom/estrongs/android/util/an;->bL(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v1, Lcom/estrongs/android/pop/utils/bg;

    invoke-direct {v1, p0, v0, p2}, Lcom/estrongs/android/pop/utils/bg;-><init>(Landroid/app/Activity;Lcom/estrongs/android/view/aw;Lcom/estrongs/fs/h;)V
    ...
    invoke-direct {v1, p0, v0, v2}, Lcom/estrongs/android/ui/dialog/ix;-><init>(Landroid/app/Activity;Ljava/lang/String;Lcom/estrongs/a/a;)V
    ...
    invoke-static {p0, p1, p2, p4}, Lcom/estrongs/android/pop/utils/aj;->c(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V

    goto :goto_0

    :cond_4
    new-instance v0, Lcom/estrongs/android/pop/utils/bi;

    invoke-direct {v0, p0, p1, p2, p4}, Lcom/estrongs/android/pop/utils/bi;-><init>(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-virtual {v1, v0}, Lcom/estrongs/android/ui/pcs/a;->a(Lcom/estrongs/android/ui/pcs/o;)V
    ...
    invoke-direct {v1, p0}, Lcom/estrongs/android/ui/pcs/j;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Lcom/estrongs/android/ui/pcs/j;->a(Lcom/estrongs/android/ui/pcs/o;)V

    invoke-virtual {v1}, Lcom/estrongs/android/ui/pcs/j;->show()V
...
.method public static a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;ZZLcom/estrongs/a/a/p;Z)V
    ...
    new-instance v7, Lcom/estrongs/android/ui/dialog/cv;

    invoke-direct {v7, p0, p1, p2, p3}, Lcom/estrongs/android/ui/dialog/cv;-><init>(Landroid/content/Context;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/estrongs/android/pop/utils/be;-><init>(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;ZZLcom/estrongs/a/a/p;)V

    invoke-virtual {v7, v8, v0}, Lcom/estrongs/android/ui/dialog/cg;->setConfirmButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/widget/Button;
    ...
    new-instance v1, Lcom/estrongs/android/pop/utils/bf;

    invoke-direct {v1}, Lcom/estrongs/android/pop/utils/bf;-><init>()V

    invoke-virtual {v7, v0, v1}, Lcom/estrongs/android/ui/dialog/cg;->setCancelButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/widget/Button;

    invoke-virtual {v7}, Lcom/estrongs/android/ui/dialog/cg;->show()V

    goto :goto_0

    :cond_2
    invoke-static/range {p0 .. p5}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;ZZLcom/estrongs/a/a/p;)V
...
.method public static a(Landroid/app/Activity;Ljava/util/List;Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/estrongs/fs/b/y;-><init>(Landroid/app/Activity;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, v0}, Lcom/estrongs/android/pop/utils/ay;-><init>(Landroid/app/Activity;Lcom/estrongs/fs/b/y;)V

    invoke-virtual {v0, v1}, Lcom/estrongs/fs/b/y;->addTaskStatusChangeListener(Lcom/estrongs/a/a/p;)V
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0}, Lcom/estrongs/android/pop/utils/aq;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2}, Lcom/estrongs/android/pop/utils/ap;-><init>()V
...
.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Lcom/estrongs/android/ui/pcs/s;Ljava/util/List;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v2, v0}, Lcom/estrongs/android/ui/dialog/dj;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Lcom/estrongs/android/pop/utils/aw;

    invoke-direct {v0, p0, p1, p2}, Lcom/estrongs/android/pop/utils/aw;-><init>(Lcom/estrongs/android/pop/esclasses/ESActivity;Lcom/estrongs/android/ui/pcs/s;Ljava/util/List;)V
    ...
    invoke-virtual {p1}, Lcom/estrongs/android/ui/pcs/s;->g()Ljava/lang/String;
    ...
    invoke-static {p0, p2, v1, v4}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-static {v0}, Lcom/estrongs/android/util/an;->bN(Ljava/lang/String;)Ljava/lang/String;
...
.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;)V
    ...
    :cond_1
    new-instance v1, Lcom/estrongs/android/ui/dialog/ap;

    invoke-direct {v1, p0, p1, v0}, Lcom/estrongs/android/ui/dialog/ap;-><init>(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Ljava/lang/String;)V

    invoke-virtual {v1}, Lcom/estrongs/android/ui/dialog/ap;->a()V

    goto :goto_0
.end method

.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1}, Lcom/estrongs/android/util/an;->aG(Ljava/lang/String;)Z
    ...
    new-instance v5, Lcom/estrongs/android/pop/utils/bl;

    invoke-direct {v5}, Lcom/estrongs/android/pop/utils/bl;-><init>()V
    ...
    new-instance v5, Lcom/estrongs/android/pop/utils/bm;

    invoke-direct {v5}, Lcom/estrongs/android/pop/utils/bm;-><init>()V
    ...
    :cond_9
    invoke-static {p0, v2, p2, p3}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V

    goto/16 :goto_0
.end method

.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;ZZLcom/estrongs/a/a/p;ZZZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/estrongs/android/pop/utils/bn;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/estrongs/android/pop/utils/bn;-><init>(Lcom/estrongs/android/pop/utils/ak;)V
    ...
    invoke-static/range {v0 .. v8}, Lcom/estrongs/android/pop/utils/bn;->a(Lcom/estrongs/android/pop/utils/bn;Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;ZZLcom/estrongs/a/a/p;ZZZ)V
...
.method public static a(Landroid/app/Activity;Lcom/estrongs/fs/h;Ljava/lang/String;Ljava/lang/String;ZZ)Z
    ...
    invoke-direct/range {v0 .. v6}, Lcom/estrongs/android/pop/utils/ax;-><init>(Landroid/app/Activity;Lcom/estrongs/fs/h;Ljava/lang/String;Ljava/lang/String;[ZZ)V
...
.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Lcom/estrongs/a/a/p;Lcom/estrongs/android/pop/utils/cb;)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v3}, Lcom/estrongs/android/pop/utils/bn;-><init>(Lcom/estrongs/android/pop/utils/ak;)V
...
.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Lcom/estrongs/android/view/aw;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p0, p1, p2, v1}, Lcom/estrongs/android/pop/utils/bn;->a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Lcom/estrongs/android/view/aw;Lcom/estrongs/a/a/p;)Z
...
.method public static a(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;Lcom/estrongs/android/view/aw;Lcom/estrongs/a/a/p;ILjava/lang/String;Z)Z
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v5}, Lcom/estrongs/android/pop/utils/bn;-><init>(Lcom/estrongs/android/pop/utils/ak;)V
...
.method private static a(Ljava/util/List;)Z
    ...
    invoke-static {v0}, Lcom/estrongs/android/util/bd;->c(Ljava/lang/String;)Z
...
.method static synthetic b(Lcom/estrongs/fs/h;)I
    ...
    invoke-static {p0}, Lcom/estrongs/android/pop/utils/aj;->c(Lcom/estrongs/fs/h;)I
...
.method private static b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->e(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p0}, Lcom/estrongs/android/util/bd;->d(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->g(Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->h(Ljava/lang/String;)Z
    ...
    :cond_4
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->i(Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->F(Ljava/lang/String;)Z
    ...
    :cond_7
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->C(Ljava/lang/String;)Z
    ...
    :cond_b
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->q(Ljava/lang/String;)Z
    ...
    :cond_c
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->s(Ljava/lang/String;)Z
    ...
    :cond_d
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->t(Ljava/lang/String;)Z
    ...
    :cond_e
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->j(Ljava/lang/String;)Z
    ...
    :cond_f
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->r(Ljava/lang/String;)Z
    ...
    :cond_11
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->u(Ljava/lang/String;)Z
    ...
    :cond_12
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->z(Ljava/lang/String;)Z
    ...
    :cond_13
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->B(Ljava/lang/String;)Z
    ...
    :cond_14
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->k(Ljava/lang/String;)Z
    ...
    :cond_15
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->A(Ljava/lang/String;)Z
    ...
    :cond_17
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->v(Ljava/lang/String;)Z
    ...
    :cond_18
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->w(Ljava/lang/String;)Z
    ...
    :cond_19
    invoke-static {p0}, Lcom/estrongs/android/util/bd;->x(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1a

    invoke-static {p0}, Lcom/estrongs/android/util/bd;->y(Ljava/lang/String;)Z
...
.method public static b(Landroid/app/Activity;Ljava/util/List;)V
    ...
    invoke-static {v1}, Lcom/estrongs/android/util/an;->bL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v4}, Lcom/estrongs/android/pop/utils/as;-><init>(Landroid/app/Activity;Ljava/util/List;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/estrongs/android/ui/dialog/ix;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/estrongs/android/ui/dialog/ix;
    ...
    invoke-static {p0, v0, v9}, Lcom/estrongs/android/ui/view/ag;->a(Landroid/content/Context;Ljava/lang/CharSequence;I)V
    ...
    invoke-static {p1}, Lcom/estrongs/android/pop/utils/aj;->b(Ljava/util/List;)Z
...
.method static synthetic b(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/estrongs/android/pop/utils/aj;->c(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
...
.method public static b(Lcom/estrongs/android/pop/esclasses/ESActivity;Ljava/util/List;)V
    ...
    invoke-static {p0, v0, p1}, Lcom/estrongs/android/pop/utils/aj;->a(Lcom/estrongs/android/pop/esclasses/ESActivity;Lcom/estrongs/android/ui/pcs/s;Ljava/util/List;)V

    :goto_0
    return-void

    :cond_0
    new-instance v1, Lcom/estrongs/android/pop/utils/bd;

    invoke-direct {v1, p0, v0, p1}, Lcom/estrongs/android/pop/utils/bd;-><init>(Lcom/estrongs/android/pop/esclasses/ESActivity;Lcom/estrongs/android/ui/pcs/s;Ljava/util/List;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/estrongs/android/pop/utils/aj;->a(Landroid/app/Activity;Lcom/estrongs/android/ui/pcs/o;Ljava/lang/String;)Lcom/estrongs/android/ui/dialog/ct;
...
.method private static b(Ljava/util/List;)Z
    ...
    invoke-static {v0}, Lcom/estrongs/android/util/bd;->g(Ljava/lang/String;)Z
...
.method private static c(Lcom/estrongs/fs/h;)I
    ...
    invoke-direct {v1}, Lcom/estrongs/android/pop/utils/ar;-><init>()V
...
.method private static c(Landroid/app/Activity;Ljava/util/List;Lcom/estrongs/fs/h;Z)V
    ...
    invoke-direct {v0, v1, p1, p2}, Lcom/estrongs/fs/b/ao;-><init>(Lcom/estrongs/fs/d;Ljava/util/List;Lcom/estrongs/fs/h;)V

    new-instance v1, Lcom/estrongs/android/pop/utils/bj;

    invoke-direct {v1, v0, p0, p2, p1}, Lcom/estrongs/android/pop/utils/bj;-><init>(Lcom/estrongs/fs/b/ao;Landroid/app/Activity;Lcom/estrongs/fs/h;Ljava/util/List;)V

    invoke-virtual {v0, v1}, Lcom/estrongs/fs/b/ao;->addPostListener(Lcom/estrongs/a/a/o;)V

    invoke-virtual {v0, p3}, Lcom/estrongs/fs/b/ao;->b(Z)V
    ...
    invoke-static {v4}, Lcom/estrongs/android/util/an;->bL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/estrongs/fs/b/ao;->setDescription(Ljava/lang/String;)V

    invoke-virtual {v0, v5}, Lcom/estrongs/fs/b/ao;->a(Z)V
