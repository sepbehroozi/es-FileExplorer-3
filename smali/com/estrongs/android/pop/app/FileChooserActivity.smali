...
.method private a(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-static {p2}, Lcom/estrongs/android/util/bd;->g(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p2, v4}, Lcom/estrongs/android/util/ak;->a(Landroid/content/ContentResolver;Ljava/lang/String;I)Landroid/net/Uri;
...
.method private b(Lcom/estrongs/fs/h;)V
    ...
    :cond_1
    invoke-static {p0, p1}, Lcom/estrongs/android/util/az;->b(Landroid/content/Context;Lcom/estrongs/fs/h;)Landroid/content/Intent;
    ...
    invoke-direct {v1, p0, v3, p1, v4}, Lcom/estrongs/android/pop/app/cj;-><init>(Lcom/estrongs/android/pop/app/FileChooserActivity;Ljava/lang/String;Lcom/estrongs/fs/h;Landroid/content/Intent;)V
    ...
    :cond_5
    invoke-static {v3}, Lcom/estrongs/android/util/bd;->c(Ljava/lang/String;)Z
    ...
    :cond_c
    invoke-static {v3}, Lcom/estrongs/android/util/bd;->g(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_d

    invoke-static {v3}, Lcom/estrongs/fs/impl/media/b;->d(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :cond_d
    invoke-static {v3}, Lcom/estrongs/android/util/bd;->h(Ljava/lang/String;)Z
    ...
    new-instance v6, Lcom/estrongs/android/pop/app/ca;

    invoke-direct {v6, p0, v4, v3, v0}, Lcom/estrongs/android/pop/app/ca;-><init>(Lcom/estrongs/android/pop/app/FileChooserActivity;Landroid/content/Intent;Ljava/lang/String;Landroid/net/Uri;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :cond_5
    new-instance v3, Lcom/estrongs/android/pop/app/bz;

    invoke-direct {v3, p0, v0}, Lcom/estrongs/android/pop/app/bz;-><init>(Lcom/estrongs/android/pop/app/FileChooserActivity;Z)V
    ...
    invoke-direct {v3, p0, v0}, Lcom/estrongs/android/pop/app/cc;-><init>(Lcom/estrongs/android/pop/app/FileChooserActivity;Z)V
