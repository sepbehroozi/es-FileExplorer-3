.class public abstract Lcom/estrongs/fs/impl/media/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/estrongs/fs/impl/media/d;->a:Landroid/graphics/BitmapFactory$Options;
    ...
    sput-object v0, Lcom/estrongs/fs/impl/media/d;->b:Ljava/text/SimpleDateFormat;

    sget-object v0, Lcom/estrongs/fs/impl/media/d;->b:Ljava/text/SimpleDateFormat;
...
.method private static a(Landroid/media/ExifInterface;)J
    ...
    :try_start_0
    sget-object v4, Lcom/estrongs/fs/impl/media/d;->b:Ljava/text/SimpleDateFormat;
...
.method public static a(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/i;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static/range {p3 .. p3}, Lcom/estrongs/android/pop/app/b/q;->b(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2}, Lcom/estrongs/android/pop/app/b/q;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_0
    new-instance v20, Lcom/estrongs/android/pop/app/b/r;

    const/4 v2, 0x0

    move-object/from16 v0, v20

    invoke-direct {v0, v2}, Lcom/estrongs/android/pop/app/b/r;-><init>(Z)V
    ...
    new-instance v3, Lcom/estrongs/android/pop/app/b/v;
    ...
    invoke-direct {v3, v2, v5}, Lcom/estrongs/android/pop/app/b/v;-><init>(Ljava/lang/String;Z)V

    move-object/from16 v0, v20

    invoke-virtual {v0, v3}, Lcom/estrongs/android/pop/app/b/r;->a(Lcom/estrongs/fs/i;)V

    move-object v8, v3

    :goto_1
    invoke-static {}, Lcom/estrongs/android/util/an;->l()Lcom/estrongs/fs/i;

    move-result-object v2

    move-object/from16 v0, v20

    invoke-virtual {v0, v2}, Lcom/estrongs/android/pop/app/b/r;->a(Lcom/estrongs/fs/i;)V

    invoke-static {}, Lcom/estrongs/android/pop/utils/aa;->f()[Lcom/estrongs/android/pop/utils/af;

    move-result-object v9

    invoke-static {v9}, Lcom/estrongs/android/pop/utils/aa;->a([Lcom/estrongs/android/pop/utils/af;)[Ljava/lang/String;
    ...
    new-instance v2, Lcom/estrongs/fs/impl/media/e;

    move-object/from16 v0, v21

    invoke-direct {v2, v9, v0}, Lcom/estrongs/fs/impl/media/e;-><init>([Lcom/estrongs/android/pop/utils/af;[Ljava/lang/String;)V
    ...
    iget-boolean v5, v5, Lcom/estrongs/android/pop/utils/af;->a:Z
    ...
    :cond_20
    :try_start_6
    invoke-static/range {p0 .. p0}, Lcom/estrongs/android/util/an;->aY(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lcom/estrongs/android/pop/app/b/r;->a(Lcom/estrongs/fs/h;)Z
    ...
    invoke-direct {v5, v0, v2, v6}, Lcom/estrongs/fs/impl/n/a;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/h;)V

    if-eqz v8, :cond_22

    invoke-virtual {v8}, Lcom/estrongs/android/pop/app/b/v;->a()I

    move-result v6

    iput v6, v5, Lcom/estrongs/fs/impl/n/a;->a:I
    ...
    invoke-direct {v2}, Lcom/estrongs/fs/impl/media/f;-><init>()V
...
.method public static a(Ljava/util/List;Ljava/util/Set;)V
    ...
    :cond_17
    invoke-static {v5}, Lcom/estrongs/android/util/bd;->S(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/estrongs/android/util/bd;->b(Ljava/lang/String;)I
    ...
    sget-object v21, Lcom/estrongs/fs/impl/media/b;->f:Ljava/util/Set;
    ...
    :goto_1b
    sget-object v6, Lcom/estrongs/fs/impl/media/b;->b:[Ljava/lang/String;
    ...
    :cond_33
    :try_start_f
    invoke-static {}, Lcom/estrongs/android/util/be;->h()Z
    ...
    invoke-static {}, Lcom/estrongs/android/util/be;->g()Z
    :try_end_10
    ...
    :try_start_11
    sget-object v7, Lcom/estrongs/fs/impl/media/d;->a:Landroid/graphics/BitmapFactory$Options;
    ...
    sget-object v10, Lcom/estrongs/fs/impl/media/d;->a:Landroid/graphics/BitmapFactory$Options;
    ...
    :cond_38
    invoke-static {v6}, Lcom/estrongs/fs/impl/media/d;->a(Landroid/media/ExifInterface;)J
    ...
    :cond_3b
    invoke-static {v6}, Lcom/estrongs/fs/impl/media/d;->b(Landroid/media/ExifInterface;)J
...
.method public static e(Ljava/lang/String;)V
    ...
    invoke-static {v1, v2}, Lcom/estrongs/fs/impl/media/d;->a(Ljava/util/List;Ljava/util/Set;)V
...
.method public a(Lcom/estrongs/fs/h;Lcom/estrongs/fs/i;Lcom/estrongs/android/util/TypedMap;)Ljava/util/List;
    ...
    invoke-static {p3}, Lcom/estrongs/android/pop/utils/cd;->a(Lcom/estrongs/android/util/TypedMap;)Z
    ...
    new-instance v8, Lcom/estrongs/android/pop/app/b/r;

    invoke-direct {v8, v3}, Lcom/estrongs/android/pop/app/b/r;-><init>(Z)V

    array-length v0, v2

    if-le v0, v1, :cond_2

    new-instance v0, Lcom/estrongs/fs/impl/media/g;

    invoke-direct {v0, p0, v2, v4}, Lcom/estrongs/fs/impl/media/g;-><init>(Lcom/estrongs/fs/impl/media/d;[Lcom/estrongs/android/pop/utils/af;[Ljava/lang/String;)V

    invoke-virtual {v8, v0}, Lcom/estrongs/android/pop/app/b/r;->a(Lcom/estrongs/fs/i;)V
    ...
    invoke-virtual {p0}, Lcom/estrongs/fs/impl/media/d;->a()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/estrongs/android/pop/ad;->p()Z
    ...
    invoke-virtual {v8, v2}, Lcom/estrongs/android/pop/app/b/r;->a(Lcom/estrongs/fs/h;)Z

    move-result v3

    if-eqz v3, :cond_c

    invoke-virtual {p0, v2}, Lcom/estrongs/fs/impl/media/d;->a(Lcom/estrongs/fs/impl/local/f;)Lcom/estrongs/fs/h;
